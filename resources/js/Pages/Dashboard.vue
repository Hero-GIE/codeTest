...
const exportAnalytics = async (period = "30days") => {
    ...
    try {
        const response = await fetch(
            `/dashboard/analytics/export?period=${period}`
        );
...
const publishedPagesCount = () => {
    return Object.values(props.pageStatus || {}).filter(
        (page) => page.published
    ).length;
};
...
<template>
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
                            ...
                            >
                                ...
                                <div class="relative">
                                    ...
                                    >
                                        <!-- Header -->
                                        <div
                                            class="p-6 bg-black border-b border-gray-800"
                                        >
                                            <div
                                            ...
                                            >
                                                ...
                                                <div class="min-w-0 flex-1">
                                                    ...
                                                    <p
                                                        class="text-sm text-white truncate mt-1"
                                                    >
                                                        {{
                                                            user?.email ||
                                                            "No email"
                                        ...
                                        <!-- User Stats -->
                                        <div
                                            class="p-6 bg-gray-50 border-b border-gray-200"
                                        >
                                            <div class="grid grid-cols-2 gap-4">
                                                <div class="text-center">
                                                    ...
                                                    <p
                                                        class="text-sm font-bold text-black mt-1"
                                                    >
                                                        {{
                                                            user?.created_at
                                                                ? new Date(
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                <span
                                                    class="font-mono font-bold text-black bg-gray-200 px-2 py-1 rounded"
                                                >
                                                    {{
                                                        user?.uid?.substring(
                                                            0,
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <!-- Tabs Navigation -->
            <div
                class="border-b border-gray-200 dark:border-gray-700 mb-6 overflow-x-auto"
            >
            ...
            <div v-if="activeTab === 'overview'" class="space-y-4 sm:space-y-6">
                <!-- Stats Cards -->
                <div
                    class="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6"
                >
                    <!-- Total Visitors Card -->
                    <div
            ...
            >
                ...
                >
                    ...
                    >
                        <div class="flex-1 min-w-0">
                            ...
                            >
                                Track your website performance and visitor
                                behavior
                            </p>
                        </div>
                        <div
                        ...
                        >
                            ...
                            >
                                <FontAwesomeIcon
                                    :icon="
                                        exportLoading ? faSpinner : faDownload
                                    "
                ...
                <div v-if="loadingAnalytics" class="text-center py-8 sm:py-12">
                    ...
                    />
                    <p
                        class="text-gray-600 dark:text-gray-400 mt-3 sm:mt-4 text-sm sm:text-base"
                    >
                ...
                <div v-else-if="analyticsData" class="space-y-4 sm:space-y-6">
                    <!-- Summary Cards -->
                    <div
                        class="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6"
                    >
                        <div
                    ...
                    >
                        <h4
                            class="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-3 sm:mb-4"
                        >
                            Page Performance
                        </h4>
                        <div class="space-y-3 sm:space-y-4">
                            ...
                            >
                                ...
                                >
                                    <FontAwesomeIcon
                                        :icon="
                                            PAGE_ICONS[page.page] || faFileAlt
                                        "
                                ...
                                <div
                                    class="flex items-center space-x-3 sm:space-x-4 ml-2"
                                >
                                    <div class="text-right">
                                        ...
                                        <p
                                            class="font-bold text-gray-900 dark:text-white text-xs sm:text-sm"
                                        >
                                            {{ page.views }}
                                        </p>
                                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        >
                            ...
                            <div
                                class="h-32 sm:h-40 lg:h-48 flex items-center justify-center text-gray-500 dark:text-gray-400"
                            >
                                <div class="text-center">
                                    <FontAwesomeIcon
                                        :icon="faChartLine"
                                    ...
                                    <p class="text-xs mt-1 sm:mt-2">
                                        ({{
                                            analyticsData.time_series?.length ||
                                            0
                                        }}
                                        data points)
                                    </p>
                ...
                <div v-else class="text-center py-8 sm:py-12">
                    ...
                    />
                    <h3
                        class="text-lg sm:text-xl font-bold text-gray-600 dark:text-gray-400 mb-2"
                    >
                        No Analytics Data Yet
                    </h3>
                    <p
                        class="text-gray-500 dark:text-gray-500 text-sm sm:text-base"
                    >
                        Your analytics data will appear here once you start
                        receiving visitors.
                    </p>
                </div>
            </div>
            ...
            >
                <div
                    class="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200 dark:border-gray-700"
                >
                    <h3
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p
                                    class="text-gray-500 dark:text-gray-400 text-xs sm:text-sm truncate"
                                >
                                    {{ status.title }}
                                </p>
                            </div>
                        ...
                        <div class="flex flex-wrap gap-2 sm:gap-3">
                            ...
                            >
                                ...
                                />
                                <span>{{
                                    status.published ? "Published" : "Set Live"
                                }}</span>
                            </button>
                            <Link
            ...
            >
                ...
                <div class="mb-6 sm:mb-8">
                    <h4
                        class="font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4 text-sm sm:text-base"
                    >
