        ...
        <div class="w-full max-w-xs sm:max-w-sm md:max-w-md relative z-10">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl shadow-black/40 sm:shadow-black/50 border border-gray-300 p-6 sm:p-8 transition-all duration-500 hover:shadow-xl sm:hover:shadow-3xl hover:shadow-black/20 hover:border-gray-400">
                ...
                <form @submit.prevent="submit" class="space-y-4 sm:space-y-6">
                    <!-- Name Field -->
                    <div class="group">
                        <InputLabel for="name" value="Full Name" class="mb-2 sm:mb-3 text-xs sm:text-sm font-medium text-gray-700" />
                        <div class="relative">
                            <TextInput
                                ref="nameInput"
                                id="name"
                        ...
                        <InputError class="mt-1 sm:mt-2 text-xs sm:text-sm text-red-600" :message="form.errors.name" />
                    </div>
                    ...
                    <div class="group">
                        <InputLabel for="password_confirmation" value="Confirm Password" class="mb-2 sm:mb-3 text-xs sm:text-sm font-medium text-gray-700" />
                        <div class="relative">
                            <TextInput
                        ...
                        <InputError class="mt-1 sm:mt-2 text-xs sm:text-sm text-red-600" :message="form.errors.password_confirmation" />
                    </div>

                    <!-- Password Requirements -->
                    <div class="bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4">
                        <h4 class="text-xs sm:text-sm font-medium text-gray-800 mb-2 flex items-center gap-2">
