  ...
  <div class="min-h-screen bg-white global-theme" :style="rootStyles">
        ...
        <div class="flex justify-between items-center h-16">
          ...
          <nav class="hidden md:flex space-x-4 lg:space-x-8">
            <Link
              ...
              :class="[page === navPage ? 'border-b-2 font-semibold' : 'hover:opacity-80']"
              :style="{
                color: `var(--header-text-color, var(--color-primary))`,
                borderColor:
                  page === navPage
                    ? `var(--header-text-color, var(--color-primary))`
                    : 'transparent',
              }"
            >
          ...
          <button
            ...
            :style="{ color: `var(--header-text-color, var(--color-primary))` }"
          >
            <FontAwesomeIcon :icon="mobileMenuOpen ? faTimes : faBars" class="w-5 h-5" />
          </button>
        </div>
      </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <nav class="space-y-3 mb-6">
            <Link
              ...
              :class="[page === navPage ? 'bg-gray-100/50 font-semibold' : 'hover:bg-gray-100/30']"
              :style="{
                color: `var(--header-text-color, var(--color-primary))`,
                borderLeftColor:
                  page === navPage
    ...
    <footer class="bg-black text-white py-12 lg:py-16 mt-20 relative overflow-hidden theme-footer">
      ...
      <div class="absolute inset-0 opacity-5">
        <div
          class="absolute top-10 left-10 w-20 h-20 sm:w-32 sm:h-32 bg-accent rounded-full blur-xl"
        ></div>
        <div
          class="absolute bottom-10 right-10 w-24 h-24 sm:w-40 sm:h-40 bg-primary rounded-full blur-xl"
        ></div>
        <div
          class="absolute top-1/2 left-1/4 w-16 h-16 sm:w-24 sm:h-24 bg-secondary rounded-full blur-lg"
        ></div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-8 lg:mb-12">
          ...
          <div class="md:col-span-2">
            <div class="flex items-center space-x-3 mb-4 lg:mb-6">
              ...
              <h3
                class="text-2xl lg:text-3xl font-black bg-gradient-to-r from-accent via-yellow-200 to-accent bg-clip-text text-transparent"
              >
                Adventure Log
              </h3>
            </div>
            <p class="text-gray-300 text-base lg:text-lg leading-relaxed mb-4 lg:mb-6 max-w-md">
              Where every journey becomes a story worth telling. Document your adventures, inspire
              fellow explorers, and create memories that last forever.
            </p>
            ...
            <div class="flex space-x-3 lg:space-x-4">
              ...
              >
                <FontAwesomeIcon
                  :icon="social.icon"
                  class="text-gray-400 group-hover:text-white text-lg lg:text-xl"
                />
              </a>
            </div>
          </div>
          ...
          <div>
            <h4
              class="text-lg lg:text-xl font-bold mb-4 lg:mb-6 text-accent inline-flex items-center space-x-2"
            >
            ...
            <div class="space-y-2 lg:space-y-3">
              ...
              >
                <span
                  class="w-2 h-2 bg-accent rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                ></span>
            ...
            <div class="space-y-3 lg:space-y-4">
              ...
              <div class="text-center">
                <p class="text-gray-400 text-xs lg:text-sm">
                  Join
                  <span class="text-accent font-bold">10,000+</span>
                  adventurers
                </p>
              </div>
            </div>
    ...
    <div
      ...
      class="fixed bottom-4 right-4 bg-blue-600 text-white px-3 py-2 lg:px-4 lg:py-3 rounded-lg shadow-xl z-50 animate-pulse"
    >
    ...
    <div class="fixed bottom-4 left-4 md:hidden z-40">
      ...
      >
        <FontAwesomeIcon :icon="faChartBar" class="text-lg" />
      </Link>
    </div>
  </div>
</template>
