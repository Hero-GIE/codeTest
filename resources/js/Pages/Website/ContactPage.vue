...
<template>
  <div class="overflow-hidden theme-page">
    ...
    <section
      class="bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 text-white py-16 md:py-24 relative overflow-hidden"
    >
      <!-- Background Pattern -->
      <div class="absolute inset-0">
        ...
        <div
          class="absolute inset-0 bg-gradient-to-br from-blue-600/90 via-purple-600/60 to-indigo-700/90"
        ></div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          {{
            ...
            "We'd love to hear about your adventures and help you share them with the world. Let's create something amazing together."
          }}
        </p>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div class="space-y-6 sm:space-y-8">
            ...
            <div>
              <div
                class="inline-flex items-center space-x-2 bg-primary/10 text-primary px-3 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold mb-4 sm:mb-6"
              >
                <FontAwesomeIcon :icon="faMapMarkedAlt" />
                <span>CONTACT INFO</span>
              </div>
              <h2
                class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-primary mb-4 sm:mb-6 leading-tight"
              >
              ...
              <p class="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed">
                {{
                  pageContent?.sections?.info?.description ||
            ...
            <div class="space-y-4 sm:space-y-6">
              <!-- Email Card -->
              <div
                v-if="pageContent?.email"
                class="group relative bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl border-2 border-gray-100 hover:border-primary transition-all duration-300 hover:shadow-lg sm:hover:shadow-xl overflow-hidden"
              >
                <div
                  class="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-primary/5 to-transparent rounded-bl-full"
                ></div>
                <div class="flex items-start space-x-3 sm:space-x-5">
                  <div class="flex-shrink-0">
                    <div
                      class="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 bg-black rounded-lg sm:rounded-xl flex items-center justify-center text-accent shadow-lg group-hover:scale-105 sm:group-hover:scale-110 transition-transform"
                    >
                  ...
                  <div class="flex-1 min-w-0">
                    <h3
                      class="font-bold text-primary text-lg sm:text-xl mb-1 sm:mb-2 group-hover:text-secondary transition-colors truncate"
                    >
                      Email Us
                    </h3>
                    <p
                      class="text-gray-700 font-medium text-sm sm:text-base lg:text-lg mb-1 truncate"
                    >
                      {{ pageContent.email }}
                    </p>
                    <p
                      class="text-gray-500 text-xs sm:text-sm flex items-center space-x-1 sm:space-x-2"
                    >
              ...
              >
                <div
                  class="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-secondary/5 to-transparent rounded-bl-full"
                ></div>
                <div class="flex items-start space-x-3 sm:space-x-5">
                  <div class="flex-shrink-0">
                    <div
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-700 font-medium text-sm sm:text-base lg:text-lg mb-1">
                      Available 24/7
                    </p>
                    <p
                      class="text-gray-500 text-xs sm:text-sm flex items-center space-x-1 sm:space-x-2"
              ...
              <div
                v-if="pageContent?.social"
                class="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl border-2 border-gray-100"
              >
                <h3
                  class="font-bold text-primary text-lg sm:text-xl mb-4 sm:mb-6 flex items-center space-x-2"
                >
                  <FontAwesomeIcon :icon="faGlobe" />
                  <span class="truncate">
                    {{ pageContent?.sections?.social?.title || 'Follow Our Adventures' }}
                  </span>
                </h3>
                <div class="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  >
                    <div
                      class="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-primary to-secondary rounded-lg flex items-center justify-center text-accent group-hover:scale-105 sm:group-hover:scale-110 transition-transform flex-shrink-0"
                    >
                      <FontAwesomeIcon
                        :icon="
                          platform === 'instagram'
                    ...
                    <div class="min-w-0 flex-1">
                      <p class="font-semibold text-primary capitalize text-xs sm:text-sm truncate">
                        {{ platform }}
                      </p>
              ...
              <div class="relative overflow-hidden rounded-xl sm:rounded-2xl">
                <div
                  class="absolute inset-0 bg-gradient-to-br from-primary via-secondary to-primary"
                ></div>
                <div class="relative p-4 sm:p-6 text-accent">
                  <div class="flex items-start space-x-3 sm:space-x-4">
                    <FontAwesomeIcon
                      :icon="faQuestionCircle"
                      class="text-xl sm:text-2xl lg:text-3xl flex-shrink-0 mt-1"
                    />
                    <div class="flex-1">
                      <h3 class="font-bold text-lg sm:text-xl mb-1 sm:mb-2">Quick Support</h3>
                      <p class="opacity-95 leading-relaxed text-sm sm:text-base">
                        Need immediate help? Check our FAQ section for quick answers to common
                        questions.
                      </p>
                    </div>
                  </div>
          ...
          <div class="lg:sticky lg:top-8 h-fit">
            <div class="relative">
              <!-- Glow Effect -->
              <div
                class="absolute -inset-2 sm:-inset-1 bg-gradient-to-br from-primary via-secondary to-primary rounded-2xl sm:rounded-3xl blur-lg sm:blur-xl opacity-20"
              ></div>

              <!-- Form Card -->
              <div
                class="relative bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl p-6 sm:p-8 lg:p-10 border border-gray-100"
              >
                <!-- Header -->
                <div class="text-center mb-6 sm:mb-8">
                  <div class="flex justify-center mb-3 sm:mb-4">
                    <div
                      class="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-black to-gray-800 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg shadow-black/30 animate-float"
                    >
                      <FontAwesomeIcon :icon="faPaperPlane" class="text-white text-lg sm:text-xl" />
                    </div>
                  </div>
                  <h3
                    class="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-black to-gray-800 bg-clip-text text-transparent mb-2"
                  >
                    Send Message
                  </h3>
                ...
                <form @submit.prevent="submitForm" class="space-y-4 sm:space-y-6">
                  ...
                  <div class="group">
                    ...
                    <div class="relative">
                      ...
                      />
                      <div
                        class="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none mt-1"
                      >
                        <FontAwesomeIcon
                          :icon="faUser"
                          class="h-4 w-4 sm:h-5 sm:w-5 text-gray-500 group-focus-within:text-black transition-colors duration-300"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="pt-3 sm:pt-4">
                    ...
                    >
                      ...
                      />
                      <FontAwesomeIcon v-else :icon="faPaperPlane" class="h-4 w-4 sm:h-5 sm:w-5" />
                      {{ loading ? 'Sending...' : 'Send Message' }}
                    </button>
                  </div>

                  <p
                    class="text-gray-500 text-xs sm:text-sm text-center flex items-center justify-center space-x-1 sm:space-x-2"
                  >
                    <FontAwesomeIcon :icon="faCheckCircle" class="text-green-500 text-xs" />
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12 sm:mb-16">
          <div class="inline-block mb-4 sm:mb-6">
            <span
              class="bg-primary/10 text-primary px-4 sm:px-5 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold inline-flex items-center space-x-1 sm:space-x-2"
            >
          ...
          <h2
            class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-primary mb-3 sm:mb-4"
          >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          >
            <div class="flex items-start space-x-3 sm:space-x-4">
              ...
              <div class="flex-1 min-w-0">
                <h3
                  class="font-bold text-primary text-base sm:text-lg mb-2 sm:mb-3 group-hover:text-secondary transition-colors"
                >
                  {{ faq.q }}
                </h3>
        ...
        <div class="mt-8 sm:mt-12 text-center">
          ...
          <button
            class="inline-flex items-center space-x-2 bg-primary text-accent px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-bold hover:scale-105 transition-all duration-300 shadow-lg text-sm sm:text-base"
          >
            <FontAwesomeIcon :icon="faComments" />
